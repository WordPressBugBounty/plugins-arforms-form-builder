 ...
 * Author: Contact Form - Repute InfoSystems
...
function arforms_googlecaptcha_deactivate( $plugin_name, $network_wide ){
	if( 'arformsgooglecaptcha/arformsgooglecaptcha.php' == $plugin_name ){

		deactivate_plugins( plugin_basename( 'arformsgooglecaptcha/arformsgooglecaptcha.php'), true, false );
		$redirect_url = network_admin_url( 'plugins.php?deactivate=true' );
		wp_redirect( $redirect_url );
		die;
	}
}
add_action( 'activate_plugin', 'arforms_googlecaptcha_deactivate', 1, 2 );
