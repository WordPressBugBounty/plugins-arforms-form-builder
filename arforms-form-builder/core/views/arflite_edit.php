...
if ( $new_values['arfinputstyle'] == 'standard' || $new_values['arfinputstyle'] == 'rounded' ) {
	...
	if ( $arf_field_order != '' ) {
		...
		$arf_field_order = wp_json_encode( array_filter( $arf_field_order ) );
	}

	if ( '' != $arf_inner_field_order ) {
		$arf_inner_field_order = json_decode( $arf_inner_field_order, true );
		$arf_inner_field_order = wp_json_encode( array_filter( $arf_inner_field_order ) );
	}

	if ( $arf_field_resize_width != '' ) {
		$arf_field_resize_width = json_decode( $arf_field_resize_width, true );
		$arf_field_resize_width = wp_json_encode( array_filter( $arf_field_resize_width ) );
	}

	if ( '' != $arf_inner_field_resize_width ) {
		$arf_inner_field_resize_width = json_decode( $arf_inner_field_resize_width, true );
		$arf_inner_field_resize_width = wp_json_encode( array_filter( $arf_inner_field_resize_width ) );
	}
...
<input type="hidden" id="arflite_browser_info" value='<?php echo esc_attr( wp_json_encode( $browser_info ) ); ?>' />
<input type="hidden" id="arflite_skin_json" value="<?php echo esc_attr( base64_encode( wp_json_encode( $skinJson ) ) ); ?>" />
...
<input type="hidden" id="arf_db_json_object" value='<?php echo esc_attr( wp_json_encode( $skinJson->skins->custom ) ); ?>' />
...
<div class="arf_editor_wrapper">
	...
	<form name="arf_form" id="frm_main_form" method="post" onSubmit='return arflitemainformedit(0);'>
		...
		<input type ="hidden" id="default_style_attr" value='<?php echo esc_attr( wp_json_encode( $newarr ) ); ?>' />
						...
						<div class="arf_form_accordion_tabs">
							...
							<dl class="arf_accordion_tab_form_settings">
								<dd>
									...
									<div class="arf_accordion_container">
										...
										<div class="arf_accordion_container_row_separator"></div>
										<div class="arf_accordion_container_row arf_padding" id="arf_frm_options">
										...
										<div class="arf_accordion_container_row_container_left">
											...
											<div class="arf_accordion_inner_container">
												...
												<div id="form_bg_img_div" style="margin-left:0px; text-align:right;">
							...
							<dl class="arf_accordion_tab_input_settings">
								<dd>
									...
									<div class="arf_accordion_container">
										<div class="arf_accordion_container_row arf_padding" id="arf_label_section">
										...
										<div class="arf_accordion_container_row_separator"></div>
										<div class="arf_accordion_container_row arf_padding" id="arf_date_time_section">
										...
										<div class="arf_accordion_container_row_container_left" style="margin-left: 8px;">
											...
											<div class="arf_form_timer_val_wrapper"><input type="text" name="arfaddtimerbreakfieldhrs" id="arfaddtimerbreakfieldhrs" value="<?php echo isset( $newarr['arfaddtimerbreakfieldhrs'] ) ? esc_attr( $newarr['arfaddtimerbreakfieldhrs'] ) : ''; ?>" class="arf_form_padding_box arf_input_unithrs arf_total_unit_check arf_unit_reset_field arf_restricted_control arflite_set_timer_hours" <?php if ( in_array( 'hrs', $check_timer_attr ) ) { ?> enabled="enable" <?php } else { ?> disabled="disabled" <?php } ?> /><br />
											<span class="arf_px arf_font_size"><?php echo addslashes( esc_html__( 'Hrs', 'arforms-form-builder' ) ); //phpcs:ignore ?></span></div>

											<div class="arf_form_timer_val_wrapper"><input type="text" name="arfaddtimerbreakfieldmin" id="arfaddtimerbreakfieldmin" value="<?php echo isset( $newarr['arfaddtimerbreakfieldhrs'] ) ? esc_attr( $newarr['arfaddtimerbreakfieldmin'] ) : ''; ?>"  class="arf_form_padding_box arf_input_unitmin arf_total_unit_check arf_unit_reset_field arf_restricted_control arflite_set_timer_minutes" <?php if ( in_array( 'min', $check_timer_attr ) ) { ?> enabled="enable" <?php } else { ?> disabled="disabled" <?php } ?> /><br />
											<span class="arf_px arf_font_size"><?php echo addslashes( esc_html__( 'Min', 'arforms-form-builder' ) ); //phpcs:ignore ?></span></div>

												<div class="arf_form_timer_val_wrapper"><input type="text" name="arfaddtimerbreakfieldsec" id="arfaddtimerbreakfieldsec" value="<?php echo isset( $newarr['arfaddtimerbreakfieldsec'] ) ? esc_attr( $newarr['arfaddtimerbreakfieldsec'] ) : ''; ?>"  class="arf_form_padding_box arf_input_unitsec arf_total_unit_check arf_unit_reset_field arf_restricted_control arflite_set_timer_second" <?php if ( in_array( 'sec', $check_timer_attr ) ) { ?> enabled="enable" <?php } else { ?> disabled="disabled" <?php } ?>/><br />
											<span class="arf_px arf_font_size"><?php echo addslashes( esc_html__( 'Sec', 'arforms-form-builder' ) ); //phpcs:ignore ?></span></div>
										</div>
										...
										<div class="arf_accordion_container_row_separator"></div>
										<div class="arf_accordion_container_row arf_padding" id="arf_checkbox_radio_settings">
							...
							<div class="arf_custom_color_popup_table_row">
								...
								<div class="arf_custom_color_popup_right_item_wrapper">
									...
									<div class="arf_custom_color_popup_right_item">
										...
										<input type="hidden" name="arfmbsc" data-arfstyle="true" data-arfstyledata='<?php echo esc_attr( wp_json_encode( $skinJson->css_main_classes ) ); //phpcs:ignore ?>' data-arfstyleappend="true" data-arfstyleappendid="arf_{arf_form_id}_form_main_style" value="<?php echo esc_attr( $inputBaseColor ); //phpcs:ignore ?>" id="arfmainbasecolor" class="txtxbox_widget hex" style="width:100%;" />
									...
									<div class="arf_dropdown_wrapper arfmarginleft">
										...
										for ( $i = 32; $i <= 40; $i = $i + 4 ) {
											...
											$font_size_attr = array(
												...
												'data-default-font' => $newarr['form_title_font_size']
											);
									...
									<div class="arf_dropdown_wrapper arfmarginleft">
										...
										for ( $i = 32; $i <= 40; $i = $i + 4 ) {
											...
											$font_size_attr = array(
												...
												'class' => 'arf_custom_font_options',
												'data-default-font' => $newarr['font_size']
											);
									...
									<div class="arf_dropdown_wrapper arfmarginleft">
										...
										for ( $i = 32; $i <= 40; $i = $i + 4 ) {
											...
											$font_size_attr = array(
												...
												'data-arfstyleappendid' => 'arf_{arf_form_id}_label_font_size',
												'class' => 'arf_custom_font_options',
												'data-default-font' => $newarr['field_font_size']
											);
