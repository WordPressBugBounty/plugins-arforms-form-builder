...
<div class="arf_field_option_model" id="arf_field_option_model_skeleton">
	...
	<div class="arf_field_option_model_container">
		<div class="arf_field_option_content_row">
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="aria_label">
				<label class="arf_field_option_content_cell_label" id="arf_label_for_general"><?php echo esc_html__( 'Aria Label', 'arforms-form-builder' ); ?></label>
				<div class="arf_field_option_content_cell_input">
					<input type="text" class="arf_field_option_input_text" name="aria_label" id="aria_label" value="">
				</div>
			</div>
		...
		<div class="arf_field_option_content_cell" data-sort="-1" id="fieldsize">
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="class_selector">
				<label class="arf_field_option_content_cell_label"><?php echo esc_html__( 'Class Selector', 'arforms-form-builder' ); ?></label>
				<div class="arf_field_option_content_cell_input">
