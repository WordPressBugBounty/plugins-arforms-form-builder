...
class arflitesettingmodel {
	...
	function arfliteupdate( $params, $cur_tab = '' ) {
		...
		if ( $cur_tab == 'general_settings' ) { 
			...
			$params['frm_empty_msg'] = wp_kses( $params['frm_empty_msg'], $check_allowed_html );
			...
			$this->arfmainformiplogging   = isset( $params['frm_arfmainformiplogging'] ) ? intval( $params['frm_arfmainformiplogging'] ) : 0;
